...
def merge_data(var_name):
	if var_name in ["eto_mm", "etr_mm"]:
		bias_path = f"../../Data/Point_bias_data/{var_name}_summary_comp_all_yrs.csv"
		geojson_path = f"../../Data/Point_bias_data/Climate/{var_name}_summary_comp_all_yrs_climate.geojson"
	else:
		bias_path = f"../../Data/Point_bias_data/{var_name}_summary_comp_merged.csv"
		geojson_path = f"../../Data/Point_bias_data/Climate/{var_name}_summary_comp_merged_climate.geojson"
	...
	# Save
	output_path = f"../../Data/Point_bias_data/Climate/{var_name}_merged_with_climate.csv"
